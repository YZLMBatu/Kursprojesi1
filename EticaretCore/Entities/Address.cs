...
namespace Eticaret.Core.Entities
{
    public class Address :IEntity
    {
        ...
        [Display(Name ="BAŞLIK"),StringLength(50),Required(ErrorMessage = "{0}Alanı Zorunludur")]
        ...
        [Display(Name = "Genel Adres"),DataType(DataType.MultilineText),Required(ErrorMessage = "{0}Alanı Zorunludur")]
